...
public class Config {
	...
	public static String RUNTIME_VIBRATE_CHMOD_AVOIDCHANGE_STICK = "chmod 444 /sys/class/timed_output/vibrator/enable";
	public static String RUNTIME_VIBRATE_CHMOD_AVOIDCHANGE_CHANGE = "chmod 644 /sys/class/timed_output/vibrator/enable";
